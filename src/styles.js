const styles = {
    ...
    heroHeadText:
      "font-black text-black lg:text-[90px] sm:text-[60px] xs:text-[50px] text-[40px] lg:leading-[98px] mt-2 ",
    heroSubText:
    ...
    ParagraphText:
      "text-black font-medium lg:text-[25px] sm:text-[21px] xs:text-[15px] text-[16px] lg:leading-[35px]",
  };
